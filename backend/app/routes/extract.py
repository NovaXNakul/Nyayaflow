...
from app.services.extraction_service import llm_extract, heuristic_extract, risk_assessment, generate_action_plan_llm
...
def generate_action(req: ActionRequest):
    ...
    with SessionLocal() as db:
        ...
        try:
            ...
            plan = {
                "steps": [
                    {"step": "Assign nodal officer", "owner": doc.extracted_json.get("department", "Administration"), "due_date": datetime.utcnow().strftime("%Y-%m-%d"), "evidence_required": "Assignment memo"},
